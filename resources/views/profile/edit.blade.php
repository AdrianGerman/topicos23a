...
@section('content')
  @include('users.partials.header', [
      ...
      'description' => __(
          'Aqui puedes editar tu perfil actual, de igual modo puedes ver tu correo y tu contraseña actual y modificarla'),
      'class' => 'col-lg-7',
  ])
              ...
              <div class="pl-lg-4">
                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                  ...
                  <input type="text" name="name" id="input-name"
                    ...
                    placeholder="{{ __('') }}" value="{{ old('name', auth()->user()->name) }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                  ...
                  <input type="email" name="email" id="input-email"
                    ...
                    placeholder="{{ __('') }}" value="{{ old('email', auth()->user()->email) }}" required>
              ...
              <div class="pl-lg-4">
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="password_confirmation" id="input-password-confirmation"
                    class="form-control form-control-alternative" placeholder="{{ __('') }}" value=""
                    required>
                </div>
