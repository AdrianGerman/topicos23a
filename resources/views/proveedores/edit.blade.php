        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <form method="post" action="{{ route('vendor.update', $provider->id) }}" autocomplete="off">
                    ...
                    <div class="row{{ $errors->has('name') ? ' has-danger' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="name"
                          ...
                          value="{{ $provider->name }}" placeholder="{{ __('Nombre') }}">
                    ...
                    <div class="row{{ $errors->has('email') ? ' has-danger' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="email"
                          ...
                          value="{{ $provider->email }}" placeholder="{{ __('Correo electrónico') }}">
                    ...
                    <div class="row{{ $errors->has('telefono') ? ' has-danger' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="telefono"
                          ...
                          value="{{ $provider->telefono }}" placeholder="{{ __('Telefono') }}">
                    ...
                    <div class="row{{ $errors->has('direccion') ? ' has-danger' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="direccion"
                          ...
                          value="{{ $provider->direccion }}" placeholder="{{ __('Dirección') }}">
                    ...
                    <div class="row{{ $errors->has('ciudad') ? ' has-danger' : '' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" name="ciudad"
                          ...
                          value="{{ $provider->ciudad }}" placeholder="{{ __('Ciudad') }}">
